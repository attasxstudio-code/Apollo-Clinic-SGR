      ...
      <nav style={{
        ...
        <div className="container" style={{
          ...
          <NavLink to="/" onClick={e => { e.preventDefault(); handleNavClick('/', 'home'); }}
            ...
            <div style={{
              ...
              <img src="/logo.jpg" alt="Home Heal Clinic" height="28"
        ...
        <div className="nav-mobile-menu" style={{
          ...
          <button className="btn btn-whatsapp"
            onClick={() => window.open(`https://wa.me/919149425496?text=${encodeURIComponent('Hello! I would like to book a homecare appointment.')}`, '_blank')}
